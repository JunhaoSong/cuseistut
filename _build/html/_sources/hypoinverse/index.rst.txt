...
#. Using the second station dataset (stats_set2), run the inversion, plot the error ellipse and stations, could you conclude relationship between the error ellipse and the stations coverage? Show your codes and results(30 Points)
