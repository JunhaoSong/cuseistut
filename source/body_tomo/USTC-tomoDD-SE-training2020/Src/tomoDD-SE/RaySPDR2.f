...
! here fix bug about latitude and longitude, limit them in the range of
! -90 - 90 and -180 - 180, respectively (added by lupan, June 9, 2019)
      do while(lo.GE.360.)
         lo=lo-360.
      enddo
      ...
      ! make sure lo is limited between -180 and 180
      if(lo.lt.-180 .and. lo.gt.180) then
          write(*, *) 'lo is out of range in cellvel: ', lo
      end  if
...
c--- change it into lat-lon-dep to find velocity
      ...
      if (tlon.ge.180) tlon = tlon -360 ! added by lupan(4.18)
